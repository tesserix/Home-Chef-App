...
func setupProviderFailureDB(t *testing.T) *gorm.DB {
	...
	for _, s := range []string{
		...
		`CREATE TABLE deliveries (rider_name_enc text DEFAULT '', rider_phone_enc text DEFAULT '', id TEXT PRIMARY KEY, order_id TEXT, provider_id TEXT,
		...
		`CREATE TABLE group_orders (delivery_address_line1_enc text DEFAULT '', delivery_address_line2_enc text DEFAULT '', id TEXT PRIMARY KEY, order_id TEXT, status TEXT, payout_hold_status TEXT DEFAULT '',
