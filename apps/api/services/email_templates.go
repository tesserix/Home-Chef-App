...
// Base colors: rausch coral (#FF385C), coral-pressed (#E00B41), gray-900 (#111827)
...
<head>
  ...
  <style>
    ...
    .header { background:linear-gradient(135deg,#FF385C,#E00B41); padding:32px 40px; text-align:center; border-radius:12px 12px 0 0; }
    ...
    .btn { display:inline-block; background:#FF385C; color:#ffffff !important; text-decoration:none; padding:14px 32px; border-radius:8px; font-weight:600; font-size:15px; margin:8px 0 24px 0; }
    .btn:hover { background:#E00B41; }
    .info-box { background:#FFE8EC; border:1px solid #FFC2CE; border-radius:8px; padding:16px 20px; margin:16px 0; }
    .info-box p { color:#E00B41; margin:0; font-size:14px; }
...
func EmailOTPHTML(firstName, code string) (subject, html string) {
	...
	body := fmt.Sprintf(`
          ...
          <div style="text-align:center;margin:8px 0 24px 0;">
            <span style="display:inline-block;font-size:34px;font-weight:700;letter-spacing:10px;color:#111827;background:#FFE8EC;border:1px solid #FFC2CE;border-radius:8px;padding:16px 28px;">%s</span>
          </div>
          <div class="info-box">
...
func EmailVerificationHTML(firstName, verifyURL string) (subject, html string) {
	...
	body := fmt.Sprintf(`
          ...
          <span style="word-break:break-all;color:#FF385C;">%s</span></p>
	...
	body := fmt.Sprintf(`
          ...
          <table width="100%%" cellpadding="0" cellspacing="0" style="margin:8px 0 24px 0;">
            <tr>
              ...
              <td style="padding:12px 0;border-top:2px solid #111827;text-align:right;font-weight:700;color:#FF385C;font-size:18px;">₹%.2f</td>
            </tr>
          </table>
          ...
          %s
          <hr class="divider">
          <p class="muted">Need help? Visit <a href="https://fe3dr.com/refund" style="color:#FF385C;">our refund policy</a> or reply to this email. This is a computer-generated invoice — no signature is required.</p>
`,
		orderNumber,
...
func renderFulfilmentBlock(d *OrderInvoiceDetails) string {
	...
	return fmt.Sprintf(`<div style="border-left:3px solid #FF385C;padding:8px 12px;margin:16px 0;">%s</div>`, parts)
}
...
func renderRefundBlurb() string {
	return `<p class="muted">Cancellations and refunds are handled per our <a href="https://fe3dr.com/refund" style="color:#FF385C;">refund policy</a>. Contact support within 24 hours if anything is wrong with your order.</p>`
}
