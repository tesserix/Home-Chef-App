                ...
                <AnimatePresence>
                  {item.badge && item.badge > 0 ? (
                    <motion.span
                      ...
                      className="absolute -right-1.5 -top-1.5 flex h-4 min-w-[1rem] items-center justify-center rounded-full bg-paprika px-1 text-[10px] font-medium tabular-nums text-paper"
                      aria-label={`${item.badge} pending orders`}
                    >
