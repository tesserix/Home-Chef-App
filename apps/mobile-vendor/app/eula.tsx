...
// End User Licence Agreement — reachable from the More tab Legal group.
...
const INTRO =
  'This End User Licence Agreement (EULA) covers your right to use the Fe3dr vendor app. Home Chef (Fe3dr) is a product of Tesserix Pty Ltd (ACN 694 070 865, ABN 59 694 070 865), registered in New South Wales, Australia ("Fe3dr", "we", "us"). We grant you a limited licence to use the app; we keep ownership of the software.';

const SECTIONS: LegalSection[] = [
  {
    heading: '1. Licence grant',
    paragraphs: [
      'Fe3dr grants you a limited, non-exclusive, non-transferable, revocable licence to download and use the Fe3dr vendor app on devices you own or control, to run your kitchen on the platform, subject to this EULA and to our Terms of Service and Chef & Vendor Agreement.',
    ],
  },
  {
