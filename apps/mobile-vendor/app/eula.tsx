...
const INTRO =
  'This End User Licence Agreement (EULA) covers your right to use the Fe3dr vendor app. Fe3dr is a product of Tesserix Pty Ltd (ACN 694 070 865, ABN 59 694 070 865), registered in New South Wales, Australia ("Fe3dr", "we", "us"). We grant you a limited licence to use the app; we keep ownership of the software.';
