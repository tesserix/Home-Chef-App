...
const INTRO =
  'This End User Licence Agreement (EULA) covers your right to use the Fe3dr vendor app, provided by Tesserix Pty Ltd ("Fe3dr", "we", "us"). We grant you a limited licence to use the app; we keep ownership of the software.';
...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'This EULA is read alongside our Terms of Service, Chef & Vendor Agreement, and Privacy Policy, and relates to a platform operated in India. For any question about this EULA, contact support@fe3dr.com.',
    ],
  },
];
