    ...
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-row justify-end px-6 pt-2">
        <TouchableOpacity onPress={handleLogout} className="py-2 px-4">
          <Text className="text-sm text-gray-500 font-medium">Logout</Text>
        </TouchableOpacity>
      </View>
      ...
      <View className="flex-1 items-center justify-center px-8">
        {status === 'rejected' ? (
          <>
            ...
            <TouchableOpacity
              className="bg-orange-500 rounded-xl py-4 px-8 items-center w-full"
          ...
          <>
            ...
            <View className="bg-orange-50 rounded-xl px-4 py-3 w-full">
